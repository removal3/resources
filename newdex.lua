...
Main = (function()
	...
	Main.FetchAPI = function()
		...
		if Main.Elevated then
			...
			rawAPI = game:HttpGet("https://setup.rbxcdn.com/" .. game:HttpGet('https://setup.rbxcdn.com/versionQTStudio') .. "-API-Dump.json")
		else
	...
	Main.Init = function()
		...
		if Main.Elevated then
			...
			Main.RobloxVersion = Main.RobloxVersion or "version-1088f3c8e4a44cc7"
		end
